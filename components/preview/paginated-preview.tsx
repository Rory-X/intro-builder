    ...
    <div ref={containerRef} className="w-full overflow-hidden">
      ...
      {measured && Array.from({ length: numPages }, (_, i) => {
        ...
        return (
          <div
            key={i}
            className="relative overflow-hidden rounded-sm bg-white shadow-md ring-1 ring-black/5"
            style={{
          ...
          >
            ...
            {!isFirstPage && (
              <div
                className="absolute inset-x-0 top-0 z-[1] bg-white"
            ...
            {bottomOverlay > 0 && (
              <div
                className="absolute inset-x-0 bottom-0 z-[1] bg-white"

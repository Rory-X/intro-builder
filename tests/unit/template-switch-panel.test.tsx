...
const favorites: TemplatePanelItem[] = [
  { id: "professional", name: "专业", resolved: { source: "unified", id: "professional", html: '<div><slot data-bind="basic.name"></slot></div>', css: null, templateId: "professional", sectionIcons: {} } },
  { id: "modern", name: "现代", resolved: { source: "unified", id: "modern", html: '<div><slot data-bind="basic.name"></slot></div>', css: null, templateId: "modern", sectionIcons: {} } },
];

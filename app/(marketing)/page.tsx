...
function TemplateFrame({ children }: { children: React.ReactNode }) {
  return (
    <div className="mx-auto w-full max-w-[820px] overflow-hidden rounded-xl border shadow-lg shadow-black/5 [container-type:inline-size]" style={{ aspectRatio: "210/297", backgroundColor: "#ffffff" }}>
